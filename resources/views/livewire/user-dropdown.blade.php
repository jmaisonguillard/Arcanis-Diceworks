<div>
    ...
    class="user-select-none mr-2 relative top-[15px] bg-bastille w-auto px-3 h-[41px] flex justify-center align-middle items-center gap-x-2 text-white text-sm items-center align-middle rounded-full">
        <div class="cursor-pointer flex justify-center align-middle items-center gap-x-2">
            ...
            <ul role="list" class="divide-y divide-gray-200 text-cinder">
                @if(Auth::check())
                    ...
                    @can('viewNova', Auth::user())
                        <li class="flex items-center py-4 px-2">
                            <a href="{{ route('nova.pages.home') }}">Admin Panel</a>
                        </li>
                    @endcan
